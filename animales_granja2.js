...
lib.ssMetadata = [
		{name:"animales_granja2_atlas_1", frames: [[0,286,819,97],[821,286,819,97],[0,385,819,97],[821,385,819,97],[0,484,819,97],[0,0,823,141],[825,0,823,141],[0,143,823,141],[825,143,823,141],[821,484,217,64],[1040,484,217,64],[1259,484,197,63],[1642,286,256,256],[1650,0,229,220]]},
		{name:"animales_granja2_atlas_2", frames: [[0,1888,855,145],[628,628,512,512],[0,1053,512,512],[1142,628,512,512],[0,628,626,423],[0,0,626,626],[0,1567,450,319],[1028,1142,626,417],[514,1142,512,512],[1201,0,536,626],[628,0,571,626],[1028,1561,570,456]]}
];
...
(lib.TITULOSX = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-204.8,-24.15,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_26();
	this.instance_1.setTransform(-204.8,-24.15,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_27();
	this.instance_2.setTransform(-204.8,-24.15,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_28();
	this.instance_3.setTransform(-204.8,-24.15,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_29();
	this.instance_4.setTransform(-204.8,-24.15,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},13).to({state:[{t:this.instance_2}]},12).to({state:[{t:this.instance_3}]},14).to({state:[{t:this.instance_4}]},9).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-204.8,-24.1,409.5,48.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-205.65,-35.2,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_22();
	this.instance_1.setTransform(-205.65,-35.2,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_23();
	this.instance_2.setTransform(-205.65,-35.2,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_24();
	this.instance_3.setTransform(-205.65,-35.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},17).to({state:[{t:this.instance_2}]},15).to({state:[{t:this.instance_3}]},16).wait(1));

	// Capa_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#00CC99").s().p("");
	this.shape.setTransform(-25.2555,-0.2287);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFF00").s().p("");
	this.shape_1.setTransform(-40.2225,-10.295);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(-32.8047,4.9424);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#CCFF00").s().p("");
	this.shape_3.setTransform(-24.974,9.7917);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},17).to({state:[{t:this.shape_2}]},15).to({state:[{t:this.shape_3}]},16).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-277.1,-74.8,486,151.89999999999998);


(lib.TEIFNMWO = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("A/1lbMA/rAAAIAAK3Mg/rAAAg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF0000").s().p("A/1FcIAAq3MA/rAAAIAAK3g");

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#99FF00").s().p("A/1FcIAAq3MA/rAAAIAAK3g");

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000033").s().p("A/1FcIAAq3MA/rAAAIAAK3g");

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("A/1FcIAAq3MA/rAAAIAAK3g");

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#3300FF").s().p("A/1FcIAAq3MA/rAAAIAAK3g");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_2},{t:this.shape}]},12).to({state:[{t:this.shape_3},{t:this.shape}]},12).to({state:[{t:this.shape_4},{t:this.shape}]},15).to({state:[{t:this.shape_5},{t:this.shape}]},8).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-204.8,-35.8,409.6,71.6);


(lib.TECLA = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("AodifIQ7AAIAAE/Iw7AAg");
	this.shape.setTransform(0,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CCFF00").s().p("AodCgIAAk/IQ7AAIAAE/g");
	this.shape_1.setTransform(0,0.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#99FF00").s().p("AodCgIAAk/IQ7AAIAAE/g");
	this.shape_2.setTransform(0,0.025);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#33CCCC").s().p("AodCgIAAk/IQ7AAIAAE/g");
	this.shape_3.setTransform(0,0.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_2},{t:this.shape}]},18).to({state:[{t:this.shape_3},{t:this.shape}]},16).to({state:[{t:this.shape_3},{t:this.shape}]},13).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-55.2,-16.9,110.4,33.9);
...
(lib.KJNSG = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Capa_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("A8BlCMA4DAAAIAAKFMg4DAAAg");
	this.shape.setTransform(-41.125,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A8BFDIAAqFMA4DAAAIAAKFg");
	this.shape_1.setTransform(-41.125,0.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.KJNSG, new cjs.Rectangle(-221.5,-33.3,360.8,66.69999999999999), null);
...
p.nominalBounds = new cjs.Rectangle(-94.8,-18.8,108.5,32);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(466.5,41.2,0.5,0.5);

	this.instance_1 = new lib.TITULOSX();
	this.instance_1.setTransform(238.15,68.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Capa_2
	this.instance_2 = new lib.KJNSG();
	this.instance_2.setTransform(686.95,81.35);

	this.instance_3 = new lib.TEIFNMWO();
	this.instance_3.setTransform(237.15,78.9);

	this.instance_4 = new lib.gallo();
	this.instance_4.setTransform(464.9,250.5,1,1,0,0,0,364.9,0);
	...
	// Capa_3
	this.instance_5 = new lib.burro();
	this.instance_5.setTransform(486.9,250.2,1,1,0,0,0,73.9,0);
	new cjs.ButtonHelper(this.instance_5, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	// Capa_5
	this.instance_6 = new lib.oveja();
	this.instance_6.setTransform(178.55,470);
	new cjs.ButtonHelper(this.instance_6, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1));

	// Capa_8
	this.instance_7 = new lib.vaca();
	this.instance_7.setTransform(758.05,249);
	new cjs.ButtonHelper(this.instance_7, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

	// Capa_7
	this.instance_8 = new lib.Cochino();
	this.instance_8.setTransform(751.5,469.8,1,1,0,0,0,67,0);
	new cjs.ButtonHelper(this.instance_8, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1));

	// Capa_6
	this.instance_9 = new lib.caballo();
	this.instance_9.setTransform(490.1,470.55);
	...
	this.instance_10 = new lib.Mapadebits2();
	this.instance_10.setTransform(-58,-79,1.6327,1.8629);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#99FFFF").s().p("EhK/AyAMAAAhj/MCV/AAAMAAABj/g");
	this.shape.setTransform(479,319.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_10},{t:this.btnPlay},{t:this.btnPausa},{t:this.btnMas2},{t:this.btnMenos2},{t:this.btnVolver}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// Titulo
	this.instance = new lib.TECLA();
	this.instance.setTransform(770.2,572.7);

	this.instance_1 = new lib.TITULO();
	this.instance_1.setTransform(262.7,74);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Capa_1
	this.instance_2 = new lib.Mapadebits1();
	this.instance_2.setTransform(0,-44,1.5497,1.6148);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/animales_granja2_atlas_1.png?1742774843390", id:"animales_granja2_atlas_1"},
		{src:"images/animales_granja2_atlas_2.png?1742774843390", id:"animales_granja2_atlas_2"},
		{src:"sounds/_006135194_prev2.mp3?1742774843441", id:"_006135194_prev2"},
		{src:"sounds/_008699584_prev.mp3?1742774843441", id:"_008699584_prev"},
		{src:"sounds/_008700019_prevmp3copia.mp3?1742774843441", id:"_008700019_prevmp3copia"},
		{src:"sounds/_008700305_prev8.mp3?1742774843441", id:"_008700305_prev8"},
		{src:"sounds/animals057.mp3?1742774843441", id:"animals057"},
		{src:"sounds/audioMp3.mp3?1742774843441", id:"audioMp3"},
		{src:"sounds/Gallo2.mp3?1742774843441", id:"Gallo2"}
	],
	preloads: []
};
